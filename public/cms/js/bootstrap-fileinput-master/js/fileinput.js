...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Arquivo  "{Name} " (<b>{size} KB</b>) excede o tamanho máximo permitido de upload de <b>{MaxSize} KB</b>. Por favor, repita o upload! ',
        msgFilesTooMany: 'Número de arquivos selecionados para upload <b>({n})</b> excede o númer máximo permitido de <b>{m}</b>. Por favor, repita o upload!',
